...
class ReturnsControllerTest < ActionController::TestCase
  ...
  test "should create return" do
    assert_difference('Return.count') do
      post :create, return: { returnComment: @return.returnComment, returnDate: @return.returnDate, sendingComment: @return.sendingComment }
    end
  ...
  test "should update return" do
    patch :update, id: @return, return: { returnComment: @return.returnComment, returnDate: @return.returnDate, sendingComment: @return.sendingComment }
    assert_redirected_to return_path(assigns(:return))
  end
